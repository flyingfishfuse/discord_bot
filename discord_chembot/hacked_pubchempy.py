...
###############################################################################
# import my stuff, after moving thier stuff to my stuff, for reasons.
from variables_for_reality import ELEMENTS, ProjectCategory, CoordinateType
from variables_for_reality import BondType, CoordinateType, API_BASE

###############################################################################

__author__ = 'Matt Swain (pubchempy code)'
